...
package npg_warehouse::Schema::Result::MultiplexedLibraryTube;
...
npg_warehouse::Schema::Result::MultiplexedLibraryTube
...
=head1 TABLE: C<multiplexed_library_tubes>

=cut

__PACKAGE__->table('multiplexed_library_tubes');
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7WZ/Z33PfAjZkX/PpwiH1g
