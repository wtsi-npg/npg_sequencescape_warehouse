...
package npg_warehouse::Schema::Result::CurrentWell;
...
=head1 TABLE: C<current_wells>

=cut

__PACKAGE__->table('current_wells');
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ty6MhFwALObxYRC67cI4hA
...
__PACKAGE__->belongs_to(
  ...
  {
    'foreign.barcode' => 'self.plate_barcode',
    'foreign.barcode_prefix' => 'self.plate_barcode_prefix',
  },
);
