use utf8;
package npg_warehouse::Schema::Result::Lane;
...
npg_warehouse::Schema::Result::Lane
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Q1Rm0g6VEj24BHVaFRcUlw
