use utf8;
package npg_warehouse::Schema::Result::CurrentReferenceGenome;
...
=head1 TABLE: C<current_reference_genomes>

=cut

__PACKAGE__->table("current_reference_genomes");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KnBrkKjA2vdygA98oJNVzg
