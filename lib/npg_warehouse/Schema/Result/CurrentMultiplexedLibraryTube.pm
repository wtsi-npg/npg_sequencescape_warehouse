use utf8;
package npg_warehouse::Schema::Result::CurrentMultiplexedLibraryTube;
...
npg_warehouse::Schema::Result::CurrentMultiplexedLibraryTube
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YnL7V97+1TC2JqrAsMq7wg
