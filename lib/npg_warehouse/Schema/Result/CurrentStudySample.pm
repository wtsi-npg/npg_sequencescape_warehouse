...
package npg_warehouse::Schema::Result::CurrentStudySample;
...
npg_warehouse::Schema::Result::CurrentStudySample
...
=head1 TABLE: C<current_study_samples>

=cut

__PACKAGE__->table('current_study_samples');
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C9s9Dk1Ytn9PGX5AzrBFuw
