use utf8;
package npg_warehouse::Schema::Result::CurrentBatchRequest;
...
npg_warehouse::Schema::Result::CurrentBatchRequest
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lw8hcXoN7B11GQq9fXug+w
