...
package npg_warehouse::Schema::Result::CurrentLibraryTube;
...
npg_warehouse::Schema::Result::CurrentLibraryTube
...
=head1 TABLE: C<current_library_tubes>

=cut

__PACKAGE__->table('current_library_tubes');
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LJP2YR3rkKO4PAGKgGMtFA
